...
If you do not have dedicated server you will need to contact iFormBuilder for directions on how to obtain a client_key and client_secret. 
...
The path to your .Renviron file will be displayed. Detailed instructions on how to add the client_key and client_secret to your .Renviron file can be found in the Appendix section of: https://cran.r-project.org/web/packages/httr/vignettes/api-packages.html 
