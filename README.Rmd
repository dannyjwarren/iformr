...
This package was inspired by the Hadley Wickham's httr package. In particular the *oauth-server-side.R* file at: https://github.com/r-lib/httr/blob/master/R/oauth-server-side.R. Encoding and signing JSON web tokens now relies on the `jose` package by Jeroen Ooms https://github.com/jeroen/jose.
